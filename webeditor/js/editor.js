...
function insert(what) {
	...
	case "code":
		...
		break;
	case "quote":
		insertHTML('<p style="margin-left: 30px;padding-left: 6px;border-left-width: 4px;border-left-style: solid;border-left-color: #B6C2C9;text-decoration: blink">'+lang["HtmlQuote"]+'<br>'+HTMLEncode(sel.text)+'</p>');
		break;
	case "h2title":
		insertHTML('<h2 class="title">' + sel.text + '</h2>');
		break;
	case "big":
