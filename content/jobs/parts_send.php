...
{
 	if(form1.name.value=="")
	{alert("请填写您的姓名!"); form1.name.focus(); return false;}
	if(form1.educational.value=="")
	{alert("请填写您的最高学历!");form1.educational.focus();return false;}
	if(form1.finishSchool.value=="")
	{alert("请填写您的毕业院校!");form1.finishSchool.focus();return false;}
	if(form1.speciality.value=="")
	{alert("请填写您的主修专业!");form1.speciality.focus();return false;}
	if(form1.experience.value=="")
	{alert("请填写您的工作经验!");form1.experience.focus();return false;}
	if(form1.email.value=="")
	{alert("请填写您的E-mail!");form1.email.focus();return false;}
	if(form1.mobile.value=="")
	{alert("请填写您的移动电话!");form1.mobile.focus();return false;}
	if(form1.resume.value=="")
	{alert("请填写您的个人简历!");form1.resume.focus();return false;}
	else{form1.submit();}
}
</script>
<style>
...
<div id="stuffbox">
<form name="form1" method="post" action="./?p=<?php echo $request['p'] ?>&r=<?php echo $request['r'] ?>&a=send"  onsubmit="return validator()">
<ul id="jobSend">
  <li>
  <label>姓名：</label><input name="name" type="text"> 
  *</li>
  <li>
  <label>性别：</label><input name="sex" type="radio" value="男" checked="checked" />
  男
  ...
  {
  	?>
	<label>出生年月：</label><input name="birthday" type="text" maxlength="50" size="25" id="lasttime" style="font-size:9pt;width:152px;BEHAVIOR: url('/inc/js/LWDP.HTC')" />
	<?php
  }
  else
  {
  ...
  <li>
  <label>民族：</label><select name="nation">
  ...
  <li>
  <label>婚姻状况：</label><input name="isMarried" type="radio" value="已婚" />
  已婚
  <input name="isMarried" type="radio" value="未婚" checked="checked" />
  未婚
  <input name="isMarried" type="radio" value="不限" />
  不限</li>  
  <li>
  <label>现有职称：</label><select name="nowJob">
  ...
  <li>
  <label>现在居住地：</label><input name="nowAddress" type="text"> 
  </li>  
  <li>
  <label>户口所在地：</label><input name="residence" type="text"> 
  </li>  
  <li>
  <label>最高学历：</label><select name="educational">
  ...
  <li>
  <label>身高：</label><input name="height" type="text"> 
  CM（厘米）</li>  
  <li>
  <label>毕业院校：</label><input name="finishSchool" type="text">*
  </li>  
  <li>
  <?php 
  if(URLREWRITE)
  {
  	?>
	<label>毕业时间：</label><input name="finishTime" type="text" maxlength="50" size="25" id="lasttime" style="font-size:9pt;width:152px;BEHAVIOR: url('/inc/js/LWDP.HTC')" />
	<?php
  }
  else
  {
  ...
  <li>
  <label>主修专业：</label><select name="speciality">
  ...
  <li>
  <label>工作经验：</label><select name="experience">
  ...
  <li>
  <label>自我评价：</label><textarea name="selfAppreciation" style="height:80px;width:300px;"></textarea>
  </li>
  
  <li>
  <label>所会外语：</label><select name="languageSkill">
  ...
  *</li>  
  <li>
  <label>住宅电话：</label><input name="telphone" type="text"> 
  </li>  
  <li>
  <label>移动电话：</label><input name="mobile" type="text"> 
  *</li>  
  <li>
  <label>通讯地址：</label><input name="address" type="text"> 
  </li>   
  <li>
  <label>个人简历：</label>
  <textarea name="resume" style="height:80px;width:300px;"></textarea>*
  </li>
  <li class="submit">
  <input type="button" name="Submit" value="提交" onClick="validator()">
  </li>
 </ul>
</form>
</div>