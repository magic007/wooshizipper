...
<div id="stuffbox">
  <table width="95%" border="0" id="tbguest">
    ...
    <tr>
      <td>交货日期</td>
      <td><input name="deliveryTime" type="text" id="deliveryTime" onMouseOver="this.style.borderColor='#9ecc00'" onMouseOut="this.style.borderColor='#D2D9D8'" style="font-size:9pt;width:152px;BEHAVIOR: url('../inc/js/LWDP.HTC')" />
        *</td>
    </tr>
    <tr>
      <td>交货方式</td>
