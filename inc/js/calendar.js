...
YAHOO.widget.Calendar.prototype.setupConfig = function() {
	...
	*/
	this.cfg.addProperty("MONTHS_LONG",		{ value:["一月", "二月", "三月", "四月", "五月", "六月", "七月", "八月", "九月", "十月", "十一月", "十二月"], handler:this.configLocale } );
	...
	*/
	this.cfg.addProperty("WEEKDAYS_SHORT",	{ value:["日", "一", "二", "三", "四", "五", "六"], handler:this.configLocale } );
