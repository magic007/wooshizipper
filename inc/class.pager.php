...
class sqlbuilder
{
	...
	private $order;
	private $anchor;
	function __construct($name,$sql,$order,$db,$pagesize=10,$paging=true,$rootpath='./',$anchor='')
	{
		$this->db=$db;
		$this->sql=$sql;
		$this->name=$name;
		...
		$tpage = $this->get_str($_GET[$name.'p']);
