...
<p>如果你不确定这些信息请联系你的虚拟主机服务供应商. 如果仍然不能解决请登陆 <a href='http://www.deepthroat.com.cn/bbs/'>深喉咙技术支持论坛</a>.</p>
");
		}
		$this->select($dbname);
	...
	<p>如果你不知道怎样在MYSQL中 设置/安装 一个数据库，那么请<strong>联系你的虚拟主机供应商</strong>. 如果都不是以上的问题请登陆 <a href='http://www.deepthroat.com.cn/bbs/'>深喉咙技术支持论坛</a>.</p>");
			}
		}
