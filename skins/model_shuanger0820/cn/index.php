...
<div id="main">
	...
	<div id="content">
		...
		<div id="cmyintro">
			...
			<div id="abtus">
			<a href="<?php echo get_root_path() ?>/?p=1"><img src="<?php echo get_skin_root() ?>/images/more.gif" alt="更多" border="0" class="more" /></a>
			<span><?php echo dt_cn_article(6,254) ?></span>
			</div>
			<img src="<?php echo get_skin_root() ?>/images/cmy_right.gif" align="right" border="0" />
		</div>
		<div id="news">
			<ul>
				<?php echo dt_list(8,5,25,0,1,true) ?>
			</ul>
		</div>
		<div id="contact"><a href="<?php echo get_root_path() ?>/?p=15"><img src="<?php echo get_skin_root() ?>/images/contact.gif" alt="联系我们" border="0" /></a></div>
	</div>
	<div id="footer">
		<div id="cprt">
...
Copyright © 2008 by Deepthroat Group Co.,Ltd, China BRAND .Inc</p>
			<p> 电话 :+86-371-66052229</p>
			<p> 传真 :+86-371-69339333-808</p>
		</div>
