...
<div id="container">
	<div id="header">
		...
		<div id="nav">
			<ul>
				<li class="ysuny"><a href="/"><span>首页</span></a></li>
	...
	<div id="pagebody">
		<div id="sideleft">
			<h1><a href="./?p=6">more..</a><img src="<?php echo get_skin_root() ?>images/comp.gif" /></h1>
			<span class="comp"><?php dt_cn_article(6,210) ?>...</span>
			<h2><a href="./?p=1">more..</a><img src="<?php echo get_skin_root() ?>images/news.gif" /></h2>
			<ul>
				<?php echo dt_list(8,5,20,0,1,true,'id') ?>
			</ul>
			<p></p>
		</div>
		<div id="sideright">
