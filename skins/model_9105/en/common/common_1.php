...
<div class="risbd">
<div class="risti"><a href="#" style="color:#fff;" target='_blank'>Recommend products</a></div>
<div class="mtlist">
<?php echo dt_product(12,2,5,0,2,false,null,'id')?>
</div>
</div>
<div class="risbd">
<div class="risti"><a href="#" style="color:#fff;" target='_blank'>Industry Advisory</a></div>
...
<?php echo dt_list(18,3,23,0,2,true,'id') ?>
</div></div>
</div>
</div>
<div class="clear"></div>
