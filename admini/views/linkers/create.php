  ...
  <tr>
    <td colspan="2" bgcolor="#FFFFFF">
	  <table width="96%" border="0" align="center" cellpadding="0" cellspacing="4">
        ...
        <tr>
          <td width="57">案例名称</td>
          <td width="861"> <input type="text" class="txt" name="linkerName" id="linkersName" style="width:30%"></td>
        </tr>
		<tr>
          <td width="57">链接地址</td>
          <td><input type="text" class="txt" name="linkAddress" id="linkAddress" style="width:30%">
          (例如：http://deepthroat.com.cn/ — 不要忘记输入http://)</td>
        </tr>
		<tr id="logo_pics">
          <td width="57">网站LOGO</td>
          <td><input name="origialPic" class="txt" type="text"  style="width:50%">
