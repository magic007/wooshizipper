...
<div class="location">当前位置: <a href="../">首 页</a> → <a href="./index.php?l=<?php echo $request['l']?>">操作员后台</a> → <a href="./index.php?m=system&s=managechannel&l=<?php echo $request['l']?>">频道及栏目设置</a> → <a href="./?m=system&s=managechannel&cid=1&a=create&l=<?php echo $request['l']?>">添加栏目</a></div>
<table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#C5EAF5">
 <form name="form1" method="post" action="?m=system&amp;s=managechannel&cid=<?php echo $request['cid'] ?>&a=create&l=<?php echo $request['l']?>">
  <tr>
...
<td colspan="2" bgcolor="#FFFFFF">
	  <table width="96%" border="0" align="center" cellpadding="0" cellspacing="4">
		...
		<tr id="styleLevel">
		  <td width="57">栏目样式</td>
		  <td colspan="2" valign="top"><?php $temp=new menu();$temp->menu_power_list_select('related_common','common.php'); ?></td>
		</tr>
		<tr>
		  <td width="57">摘要</td>
		...
		<tr id="styleIsComment">
		  <td width="57">开启评论</td>
		  <td colspan="2" valign="top"><?php show_isComment_radio($menu_item->isComment) ?><span style="color:#0000FF">[温馨提示:如果您创建的频道是留言、招聘、订单、网站地图模块请不要开启评论]</span></td>
		</tr>
		<tr>
		  <td width="57">排序</td>
