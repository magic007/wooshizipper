...
<div class="location">当前位置: <a href="./">首 页</a> → <a href="./index.php?l=<?php echo $request['l']?>">操作员后台</a> → <a href="./index.php?m=system&s=managechannel&l=<?php echo $request['l']?>">频道及栏目设置</a> → <a href="./?m=system&s=managechannel&cid=<?php echo $request['cid']?>&a=editchannel&l=<?php echo $request['l']?>">修改频道属性</a></div>
<table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#C5EAF5">
 <form name="form1" method="post" action="?m=system&s=managechannel&cid=<?php echo $request['cid'] ?>&a=editchannel&l=<?php echo $request['l']?>">
  <tr>
    <td width="892">频道管理 | <a href="javascript:history.back(1)">返回</a> </td>
