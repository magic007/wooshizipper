...
<table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#C5EAF5">
 <form name="form1" method="post" action="./index.php?a=edit_title&p=<?php echo $request['p'] ?>&c=<?php echo $request['c'] ?>&l=<?php echo $request['l']?>">
  <tr>
    <td width="892">修改投票主题 | <a href="javascript:history.back(1)">返回</a> </td>
